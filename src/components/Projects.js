...
const projects = [
  {
    ...
    description:
      'A beautiful restaurant landing page showcasing food menus, gallery, and ordering sections. Built with clean HTML and CSS.',
    tags: ['HTML', 'CSS'],
    emoji: '🍽️',
    github: 'https://github.com/neya-mul/Reasturent',
    color: '#f97316',
  },
  {
    title: 'G3 Architects',
    description:
      'A professional architecture firm portfolio website with modern layout, service sections, and project showcases.',
    tags: ['HTML', 'CSS'],
    emoji: '🏛️',
  ...
  },
  {
    title: 'Shoes Store',
    description:
      'A stylish e-commerce style website for a shoe brand. Features product cards, hero sections, and smooth UI.',
    tags: ['CSS', 'JavaScript'],
    emoji: '👟',
    github: 'https://github.com/neya-mul/shoes-website',
    color: '#10b981',
  },
  {
    title: 'Anime Cube',
    description:
      'A creative CSS animation project featuring a 3D rotating cube with anime-inspired styling and effects.',
    tags: ['CSS', 'Animation'],
    emoji: '🎌',
    github: 'https://github.com/neya-mul/Anime-Cube',
    color: '#ec4899',
  },
  {
